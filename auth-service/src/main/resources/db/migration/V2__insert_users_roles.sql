INSERT INTO users(id, username, password) VALUES
    ...
    'demo',
    '$2y$10$HUF6CnifEaXN7KfFZCjlIu5H3frotYLlQ5plPlSJLBTiXLohuHh/i')
    ON CONFLICT DO NOTHING;

INSERT INTO users(id, username, password) VALUES
    ('c24f0887-a071-4918-b17d-6a73d1356224', 'admin', '$2y$10$HUF6CnifEaXN7KfFZCjlIu5H3frotYLlQ5plPlSJLBTiXLohuHh/i')
    ON CONFLICT DO NOTHING;
