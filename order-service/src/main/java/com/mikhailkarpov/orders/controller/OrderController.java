...
import com.mikhailkarpov.orders.service.ProductService;
...
public class OrderController {
    ...
    public ResponseEntity<OrderDto> createOrder(@Valid @RequestBody CreateOrderRequest request,
        ...
        log.info("Request from {} to create order: {}", principal.getName(), request);
        OrderDto created = orderService.createOrder(principal.getName(), request);
    ...
    public List<OrderDto> findOrdersForCurrentCustomer(@AuthenticationPrincipal Principal principal) {
        ...
        return orderService.findOrdersByCustomerId(principal.getName());
    }
    ...
    public List<OrderDto> findOrdersByAccountId(@RequestParam String accountId) {
        ...
        return orderService.findOrdersByCustomerId(accountId);
    }
